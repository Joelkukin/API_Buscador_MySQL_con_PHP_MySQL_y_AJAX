function strToHtml(str){
    ...
    var miElemento = tempContainer.firstChild;
...
export default class Tabla {
    constructor(modelo) {
        ...
        let btnAgregar = strToHtml('<input type="button" id="agregar" value="agregar"></input>');
        ...
        tbody.appendChild(btnAgregar);

        this.html = tabla;
    };
    
    crearFila(valores_celdas = []){ // recibe un array con los valores de cada celda
    ...
    hacerEditable(fila_original){ // => void
 ...
 function generartabla(modelo){   // => tabla:DOMElement
